export type Phase = 'landing' | 'compare' | 'results' | 'browse' | 'styles'
...
export function Nav({ phase, picks, onNav }: Props) {
  ...
  return (
    <nav className="nav">
      ...
      <a className="nav-icon" href="https://github.com/bonkey/agents-linguistics" target="_blank" rel="noreferrer" aria-label="GitHub repository" title="GitHub repository">
